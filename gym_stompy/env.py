...
from gym_stompy.tasks.sim import BOX_POSE, InsertionTask, TransferCubeTask
from gym_stompy.tasks.sim_end_effector import (
    InsertionEndEffectorTask,
    TransferCubeEndEffectorTask,
)
from gym_stompy.utils import sample_box_pose, sample_insertion_pose


class StompyEnv(gym.Env):
